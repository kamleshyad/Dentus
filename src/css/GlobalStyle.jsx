...
.headersec .headerright ul a.bookbtn{padding: 15px 30px; background: ${({theme})=> theme.colors.light_blue}; color: ${({theme})=> theme.colors.white}; font-size: 18px; font-weight: 600; border-radius: 6px; transition: all 0.3s linear;}
`;